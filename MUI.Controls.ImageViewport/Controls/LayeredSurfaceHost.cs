...
namespace MUI.Controls.ImageViewport
{
    ...
    public class LayeredSurfaceHost : FrameworkElement
    {
        ...
        public DrawingContext? OpenExternal(LayerKind layer, bool clear)
        {
        ...
        public void ClearExternal(LayerKind layer)
        ...
        DrawingVisual? GetExternalVisual(LayerKind layer) => layer switch
        {
            LayerKind.Background => _vBackground,
            LayerKind.Active => _vActive,
            LayerKind.Preview => _vPreview,
            LayerKind.OverlayWorld => _vOverlayWorld,
            LayerKind.Hud => _vHud,
            _ => null
        };
